...
newdoc.resizeImage(Number(Blah), null, 96, ResampleMethod.BICUBICSHARPER);
...
function changetoRGB(){
	app.activeDocument.convertProfile("Working RGB", Intent.RELATIVECOLORMETRIC, true, true );
}
